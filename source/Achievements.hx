...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["I Know Where You Live",		"Beat \"Stop\" from the pause menu.",				'cheater',	    		 true],
		["How Did You Do That??",		"Beat \"Stop\" with no misses.",			    	'stop_nomiss',	    	 true],
		["Just Like I Remember It",		"idk what to say here",								'tutpatr',	    		 true]//,
		//["Unnamed Achievement",			"Beat a song using... her.",						'wtf',		    		 true] //no one cares
	];
